...
/**************************************************************************/
/*!
    @brief  Instantiates a new Accel_Mag class, including assigning
...
*/
/**************************************************************************/
Accel_Mag::Accel_Mag(int32_t accelSensorID,
                                     int32_t magSensorID) {
  _accelSensorID = accelSensorID;
  _magSensorID = magSensorID;

  accel_sensor = new Accel_Mag_Accelerometer(this);
  mag_sensor = new Accel_Mag_Magnetometer(this);
}
...
*/
/**************************************************************************/
bool Accel_Mag::begin(uint8_t addr, TwoWire *wire) {
  if (i2c_dev)
    delete i2c_dev;
...
*/
/**************************************************************************/
bool Accel_Mag::getEvent(sensors_event_t *accelEvent,
...
*/
/**************************************************************************/
void Accel_Mag::getSensor(sensor_t *accelSensor, sensor_t *magSensor) {
...
*/
/**************************************************************************/
bool Accel_Mag::getEvent(sensors_event_t *singleSensorEvent) {
...
*/
/**************************************************************************/
void Accel_Mag::getSensor(sensor_t *accelSensor) {
  sensor_t accel;
...
*/
/**************************************************************************/
void Accel_Mag::standby(boolean standby) {
  Adafruit_BusIO_Register CTRL_REG1(i2c_dev, FXOS8700_REGISTER_CTRL_REG1);
 ...
 */
Adafruit_Sensor *Accel_Mag::getAccelerometerSensor(void) {
  return accel_sensor;
}
 ...
 */
Adafruit_Sensor *Accel_Mag::getMagnetometerSensor(void) {
  return mag_sensor;
}
...
*/
/**************************************************************************/
void Accel_Mag::setSensorMode(fxos8700SensorMode_t mode) {
...
*/
/**************************************************************************/
fxos8700SensorMode_t Accel_Mag::getSensorMode() { return _mode; }
...
*/
/**************************************************************************/
void Accel_Mag::setAccelRange(fxos8700AccelRange_t range) {
  Adafruit_BusIO_Register CTRL_REG1(i2c_dev, FXOS8700_REGISTER_CTRL_REG1);
...
*/
/**************************************************************************/
fxos8700AccelRange_t Accel_Mag::getAccelRange() { return _range; }
...
*/
/**************************************************************************/
void Accel_Mag::setOutputDataRate(fxos8700ODR_t rate) {
  Adafruit_BusIO_Register CTRL_REG1(i2c_dev, FXOS8700_REGISTER_CTRL_REG1);
...
*/
/**************************************************************************/
fxos8700ODR_t Accel_Mag::getOutputDataRate() { return _rate; }
...
*/
/**************************************************************************/
void Accel_Mag::setMagOversamplingRatio(fxos8700MagOSR_t ratio) {
  Adafruit_BusIO_Register MCTRL_REG1(i2c_dev, FXOS8700_REGISTER_MCTRL_REG1);
...
*/
/**************************************************************************/
fxos8700MagOSR_t Accel_Mag::getMagOversamplingRatio() { return _ratio; }
...
*/
/**************************************************************************/
void Accel_Mag_Magnetometer::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object */
...
*/
/**************************************************************************/
bool Accel_Mag_Magnetometer::getEvent(sensors_event_t *event) {
...
*/
/**************************************************************************/
void Accel_Mag_Accelerometer::getSensor(sensor_t *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t));
...
*/
/**************************************************************************/
bool Accel_Mag_Accelerometer::getEvent(sensors_event_t *event) {
