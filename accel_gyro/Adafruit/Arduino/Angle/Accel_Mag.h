...
#ifndef __Accel_Mag_H__
#define __Accel_Mag_H__
...
*/
/**************************************************************************/
class Accel_Mag : public Adafruit_Sensor {
public:
  Accel_Mag(int32_t accelSensorID = -1, int32_t magSensorID = -1);
  ~Accel_Mag();
  ...
  Accel_Mag_Accelerometer *accel_sensor =
      NULL; ///< Accelerometer data object
  Accel_Mag_Magnetometer *mag_sensor = NULL; ///< Mag data object
