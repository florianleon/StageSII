...
/**************************************************************************/
/*!
    @brief  Instantiates a new Gyro class, including assigning
...
*/
/**************************************************************************/
bool Gyro::begin(uint8_t addr, TwoWire *wire) {
...
*/
/**************************************************************************/
void Gyro::setRange(gyroRange_t range) {
  Adafruit_BusIO_Register CTRL_REG0(i2c_dev, GYRO_REGISTER_CTRL_REG0);
...
*/
/**************************************************************************/
gyroRange_t Gyro::getRange() { return _range; }
...
*/
/**************************************************************************/
void Gyro::standby(boolean standby) {
  Adafruit_BusIO_Register CTRL_REG1(i2c_dev, GYRO_REGISTER_CTRL_REG1);
